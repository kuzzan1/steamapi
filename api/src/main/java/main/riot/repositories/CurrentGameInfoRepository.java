...
public class CurrentGameInfoRepository {
	...
	private static final int CURRENT_GAME_CACHE_MLSECS = 2 * 60 * 1000; // 2 minutes.
	...
	private CurrentGameInfo getCurrentGameInfoFromAPI(long summonerId, String locale) {
		String url = new URLBuilder()
				.baseUrl(
						"https://" + locale + ".api.pvp.net/observer-mode/rest/consumer/getSpectatorGameInfo/"
								+ locale.toUpperCase() + "1").Path(String.valueOf(summonerId))
				.Param("api_key", ApiKey.getRiotKey()).Build();
